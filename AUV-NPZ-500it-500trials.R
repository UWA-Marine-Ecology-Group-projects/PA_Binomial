...
dataComponents<-supplyData(
  ...
  scenario.data=list(
    ...
    filename="AUV-NPZ-500it-500trials-1after_binomal",
...
memfree #  7873204 kb - at the start of session 65165996
...
# memory usage
library(pryr)
mem_used() # 1.15 GB # after cleaning 165 MB, at the start of sess 48.5 MB
