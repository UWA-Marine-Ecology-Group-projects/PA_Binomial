######### Binomal Power Analysis of BRUV Data #######
...
## Set file name --
filen <- "stereo-BRUVs-HPZ-seag-epower-22092020.csv"
...
dataComponents<-supplyData(
  ...
  scenario.data=list(
    ...
    filename="BRUV-HPZ-400it_binomial_22092020",
    ...
    Number.of.trials="125; 250; 500; 1500; 2500",
