...
## Set file name --
filen <- "DTV-MUZ-seag-epower-22102020.csv"
...
dataComponents<-supplyData(
  ...
  scenario.data=list(
    ...
    filename="DTV-MUZ-400it-binomal-22102020",
...
memfree #  5392800 kb - at the start of sesson : 64877516, after 150 its: 64082116; after 300 its: 63007928
# To obtain information on the total and/or on the available memory in linux, you can try
system('free -m') # 61535 300 its - 500 its :7751
...
# memory usage
library(pryr)
mem_used() # after 150 its 301 MB -- after 300 its: 555 MB -- for 500 its: 1.14 GB
